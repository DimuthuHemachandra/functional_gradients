...
grad_ctx_12 = get_aligned_gradients(mean_ctx_12, cube_matrix_ctx_12)
grad_ctx_24 = get_aligned_gradients(mean_ctx_24, cube_matrix_ctx_24)

grad_sbctx_12 = get_aligned_gradients(mean_sbctx_12, cube_matrix_sbctx_12)
grad_sbctx_24 = get_aligned_gradients(mean_sbctx_24, cube_matrix_sbctx_24)


import dill

# Save the file
dill.dump(grad_ctx_12, file = open("/home/dimuthu1/scratch/PPMI_project2/derivatives/analysis/gradients/bs_emb/emb_ctx_12.pickle", "wb"))
dill.dump(grad_ctx_24, file = open("/home/dimuthu1/scratch/PPMI_project2/derivatives/analysis/gradients/bs_emb/emb_ctx_24.pickle", "wb"))

dill.dump(grad_sbctx_12, file = open("/home/dimuthu1/scratch/PPMI_project2/derivatives/analysis/gradients/bs_emb/emb_sbctx_R_12.pickle", "wb"))
dill.dump(grad_sbctx_24, file = open("/home/dimuthu1/scratch/PPMI_project2/derivatives/analysis/gradients/bs_emb/emb_sbctx_R_24.pickle", "wb"))
